...
# Đảm bảo bạn đã convert file XML của Playfair thành file Python và đặt trong thư mục IU
from IU.playfair import Ui_MainWindow 
...
class MyApp(QMainWindow):
    ...
    def call_api_encrypt(self):
        # Đổi endpoint sang playfair
        url = "http://127.0.0.1:5000/api/playfair/encrypt"
        
        # txt_key là QTextEdit nên cần dùng toPlainText()
        payload = {
